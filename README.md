...
- A component library with passive components, sources, ground, diodes, LEDs, BJTs, MOSFETs, transformers, 555 timers and 741 op-amps.
...
- Basic measurement and feedback panels: virtual meter, oscilloscope-style display, spectrum display, thermal view and a lightweight circuit inspector.
...
Fluxa is a static front-end project. No backend or package installation is required to run it.
...
5. Use **Export** to create PNG, SVG or JSON output, or choose **Import Fluxa JSON** to reopen a saved circuit.
...
│   │   └── fluxa-light.png        # Light-theme README screenshot
